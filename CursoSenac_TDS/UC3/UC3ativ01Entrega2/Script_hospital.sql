...
-- Schema hospital_db_andre_cararo_lowcke
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `hospital_db_andre_cararo_lowcke` DEFAULT CHARACTER SET utf8mb3 ;
...
CREATE TABLE IF NOT EXISTS `hospital_db_andre_cararo_lowcke`.`convenios` (
  ...
  `tempo_carencia` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hospital_db_andre_cararo_lowcke`.`internacao` (
  ...
  `data_alta` DATETIME NULL DEFAULT NULL,
  `procedimentos` VARCHAR(450) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hospital_db_andre_cararo_lowcke`.`consultas` (
  ...
  `medico_consulta_id` INT NULL DEFAULT '0',
  `paciente_consulta_id` INT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `hospital_db_andre_cararo_lowcke`.`enfermeira` (
  ...
  `CRE` INT UNSIGNED NULL DEFAULT NULL,
